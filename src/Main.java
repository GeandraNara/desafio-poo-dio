...
public class Main {
    public static void main(String[] args) {
        ...
        Dev devGeandra = new Dev();
        devGeandra.setNome("Geandra");
        devGeandra.inscreverBootcamp(bootcamp);
        ...
        System.out.println("XP:" + devGeandra.cacularTotalXp());
        ...
        System.out.println("XP:" + devJulia.cacularTotalXp());
